...
import { createProduct, deleteProduct, findProductById, findProductByName, getProducts, getStatus, updateProduct, getProductImageUrl } from '../controllers/productController.js'
